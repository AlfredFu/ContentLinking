...
class Article(object):
	...
	CONTENT_TYPE_MAOVERVIEW='LOMP'#企业并购实务概览
	CONTENT_TYPE_CROVERVIEW='LOCR'#商业争议解决实务概览
	CONTENT_TYPE_PGEPOVERVIEW='LOPGEP'#PG 劳动法实务概览
	CONTENT_TYPE_PGCPOVERVIEW='LOPGCP'#PG 公司法实务概览
	CONTENT_TYPE_OVERVIEW_SUMMARY='SUMMARY'
	CONTENT_TYPE_ELEARNING='EL'
	CONTENT_TYPE_PRACTICAL='PC'#实用资料
	CONTENT_TYPE_FOREIGNLAW='FL'
	CONTENT_TYPE_CKL='CKL'#PG Checklist
	CONTENT_TYPE_GOVF='GOVF'#PG Goverment Form 
	CONTENT_TYPE_SC='SC'#PG Smart chart 
	CONTENT_TYPE_TEMPLATE='TEMPLATE'#PG document template 
